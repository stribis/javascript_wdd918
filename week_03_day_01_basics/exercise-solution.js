// Using the provided Data ( which is in the form of an Array ), 
// If the post's ID is 1 or 3
// print out, each individual's name, email and message body to the console.
...
for(let i = 0; i < data.length; i++){
  // We test if the postId is either 1 or 3 using the || (or) operator
  if(data[i].postId == 1 || data[i].postId == 3 ){
    // We log the data to the console corresponding to the current iteration
